...
const Header = ()=>{
    const [Classbox] = useState('cursor-pointer bg-Home-icon bg-no-repeat bg-center bg-cover w-[50px] h-[50px] z-10 duration-700 ease-in-out max-[425px]:w-[35px] max-[425px]:h-[35px]')
    ...
    return(
        <div className="overflow">
            <div className="  w-screen h-[80px] bg-slate-400 flex justify-around items-center">
                ...
                <div className={`${Classbox} ${TranslateBox1} `} onClick={Click1}></div>
                <div className={`${Classbox} ${TranslateBox2} `} onClick={Click2}></div>
                <div className={`${Classbox} ${TranslateBox3} `} onClick={Click3}></div>
                <div className={`${Classbox} ${TranslateBox4} `} onClick={Click4}></div>
                <div className={`${Classbox} ${TranslateBox5} `} onClick={Click5}></div>
            </div>
        </div>
    );
}
